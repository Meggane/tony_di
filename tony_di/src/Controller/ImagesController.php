...
class ImagesController extends AbstractController
{
    ...
    /**
     * @Route("/new/admin", name="images_new", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $image->setUrlImage("$imageUrl/$filename");
    ...
    /**
     * @Route("/{id}/edit/admin", name="images_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}/admin", name="images_delete", methods={"DELETE"})
     */
